...
```java
Class alunbarClass1 = Class.forName("io.github.mo2feng.TargetObject");
```
...
```java
ClassLoader.getSystemClassLoader().loadClass("io.github.mo2feng.TargetObject");
```
