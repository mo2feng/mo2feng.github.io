...
### 修饰成员变量和成员方法(常用) {id="member-variables-and-member-methods"}
...
### 静态方法与非静态方法 {id="static-method-and-non-static-method"}
...
### `static{}`静态代码块与`{}`非静态代码块(构造代码块) {id="static-code-block-and-non-static-code-block"}
